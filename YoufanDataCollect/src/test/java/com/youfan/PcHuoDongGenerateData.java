...
public class PcHuoDongGenerateData {
    ...
    private static PcProductHuoDong genernateData(){
        ...
        pcProductHuoDong.setScantime(openTime);
        pcProductHuoDong.setJumpTime(leaveTime);
        ...
        pcProductHuoDong.setLogType(LogType.PC);
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 50; i++) {
            ...
            postHttpMethod("http://127.0.0.1:8091/collect/data", JSONObject.toJSONString(pcProductHuoDong));
        }
    }
}
