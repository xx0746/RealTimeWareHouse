...
public class LiuliangAppOdsAnaly {
    ...
    public static void main(String[] args) {
        ...
        FlinkKafkaConsumer<String> myConsumer = new FlinkKafkaConsumer<String>("app", new SimpleStringSchema(), properties);
//        //指定偏移量
        ...
        DataStream<String> mapstream  = stream.map(new AppOdsMap());
